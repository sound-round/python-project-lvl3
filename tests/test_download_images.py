...
NETLOC = 'badcode.ru'
HTML_PATH_BEFORE = (
    'tests/fixtures/images_download_test/images-fixture-before.html'
)
HTML_PATH_AFTER = (
    'tests/fixtures/images_download_test/images-fixture-after.html'
)
IMAGE_1_PATH_BEFORE = (
    'tests/fixtures/images_download_test/badcode-2.png'
)
IMAGE_2_PATH_BEFORE = (
    'tests/fixtures/images_download_test/game-boy-color.jpg'
)
IMAGE_1_PATH_AFTER = (
    'images-fixture-before_files/'
    'badcode-ru-content-images-2020-01-badcode-2.png'
)
IMAGE_2_PATH_AFTER = (
    'images-fixture-before_files/'
    'badcode-ru-content-images-2018-11-game-boy-color.jpg'
)
...
def test_download_images_mocking(requests_mock):
    ...
    with tempfile.TemporaryDirectory() as tmp_directory:
        ...
        assert filecmp.cmp(
            IMAGE_1_PATH_BEFORE,
            f'{tmp_directory}/{IMAGE_1_PATH_AFTER}',
            shallow=False
        )
        assert filecmp.cmp(
            IMAGE_2_PATH_BEFORE,
            f'{tmp_directory}/{IMAGE_2_PATH_AFTER}',
            shallow=False
        )
